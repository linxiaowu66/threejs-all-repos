...
function init() {
  ...
  let stoneTexture = new THREE.TextureLoader().load(
    "../../static/stone/stone.jpg"
  );
  let bumpStoneTexture = new THREE.TextureLoader().load(
    "../../static/stone/stone-bump.jpg"
  );
  ...
  boxMaterial4.normalMap = new THREE.TextureLoader().load(
    "../../static/general/plaster-normal.jpg"
  );
