...
function init() {
  ...
  gui
    ...
    .onChange((value) => lineMaterial.color.setStyle(value));
  gui
    .add(controls, "dashSize", 0, 10)
    .onChange((value) => (lineMaterial.dashSize = value));
  gui
    .add(controls, "gapSize", 0, 10)
    .onChange((value) => (lineMaterial.gapSize = value));
  gui
    .add(controls, "scale", 0, 10)
    .onChange((value) => (lineMaterial.scale = value));
