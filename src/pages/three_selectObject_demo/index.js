...
function init() {
  ...
  // 参数化几何体
  let parametricGeometry = new ParametricGeometry(
  ...
  let polyhedronGeometry = new THREE.PolyhedronGeometry(
    verticesOfCube,
    indicesOfFaces,
    5,
    2
  ...
  fontLoader.load("../../assets/fonts/FZJPKai-Z03S_Regular.json", (result) => {
    let textGeometry = new TextGeometry("你好！", {
      font: result,
      size: 5,
      height: 1,
      curveSegments: 10,
    ...
    let textControls = {
      ...
      // size: textGeometry.parameters.size,
      // height: textGeometry.parameters.height,
      curveSegments: textGeometry.parameters.options.curveSegments,
      bevelEnabled: textGeometry.parameters.options.bevelEnabled,
      bevelThickness: textGeometry.parameters.options.bevelThickness,
      bevelSize: textGeometry.parameters.options.bevelSize,
      bevelSegments: textGeometry.parameters.options.bevelSegments,
      wireframe: textMaterial.wireframe,
    };
    let updateText = function () {
      text.geometry = new TextGeometry("你好！", {
        font: result,
        // TODO: 找一下这里的解决办法！
        size: 5, // textControls.size,
        height: 1, //textControls.height,
    ...
    // textGUI
    //   .add(textControls, "height", 0, 10)
    //   .onChange((value) => updateText());
    textGUI
      .add(textControls, "curveSegments", 0, 30)
      .onChange((value) => updateText());
    textGUI.add(textControls, "bevelEnabled").onChange((value) => updateText());
    textGUI
      .add(textControls, "bevelThickness", 0, 20)
      .onChange((value) => updateText());
    textGUI
      .add(textControls, "bevelSize", 0, 20)
      .onChange((value) => updateText());
    textGUI
      .add(textControls, "bevelSegments", 0, 5)
      .onChange((value) => updateText());
    textGUI
      .add(textControls, "wireframe")
      .onChange((value) => (textMaterial.wireframe = value));
  });
  ...
  boxGUI
    .add(boxControls, "widthSegments", 0, 40)
    .onChange((value) => updateBox());
  boxGUI
    .add(boxControls, "heightSegments", 0, 40)
    .onChange((value) => updateBox());
  boxGUI
    .add(boxControls, "depthSegments", 0, 40)
    .onChange((value) => updateBox());
  boxGUI
    .add(boxControls, "wireframe")
    .onChange((value) => (boxMaterial.wireframe = value));
  ...
  let updateCone = function () {
    cone.geometry = new THREE.ConeGeometry(
      coneControls.radius,
      coneControls.height,
      coneControls.radialSegments,
      coneControls.heightSegments,
      coneControls.openEnded,
      coneControls.thetaStart,
      coneControls.thetaLength
    );
  };
  ...
  coneGUI
    .add(coneControls, "radialSegments", 0, 20)
    .onChange((value) => updateCone());
  coneGUI
    .add(coneControls, "heightSegments", 0, 20)
    .onChange((value) => updateCone());
  coneGUI.add(coneControls, "openEnded").onChange((value) => updateCone());
  coneGUI
    .add(coneControls, "thetaStart", 0, Math.PI * 2)
    .onChange((value) => updateCone());
  coneGUI
    .add(coneControls, "thetaLength", 0, Math.PI * 2)
    .onChange((value) => updateCone());
  coneGUI
    .add(coneControls, "wireframe")
    .onChange((value) => (coneMaterial.wireframe = value));
  ...
  let updateCylinder = function () {
    cylinder.geometry = new THREE.CylinderGeometry(
      ...
      cylinderControls.heightSegments,
      cylinderControls.openEnded,
      cylinderControls.thetaStart,
      cylinderControls.thetaLength
    );
  };
  cylinderGUI
    .add(cylinderControls, "radiusTop", 0, 5)
    .onChange((value) => updateCylinder());
  cylinderGUI
    .add(cylinderControls, "radiusBottom", 0, 5)
    .onChange((value) => updateCylinder());
  cylinderGUI
    .add(cylinderControls, "height", 0, 10)
    .onChange((value) => updateCylinder());
  cylinderGUI
    .add(cylinderControls, "radialSegments", 0, 20)
    .onChange((value) => updateCylinder());
  cylinderGUI
    .add(cylinderControls, "heightSegments", 0, 20)
    .onChange((value) => updateCylinder());
  cylinderGUI
    .add(cylinderControls, "openEnded")
    .onChange((value) => updateCylinder());
  cylinderGUI
    .add(cylinderControls, "thetaStart", 0, 2 * Math.PI)
    .onChange((value) => updateCylinder());
  cylinderGUI
    .add(cylinderControls, "thetaLength", 0, 2 * Math.PI)
    .onChange((value) => updateCylinder());
  cylinderGUI
    .add(cylinderControls, "wireframe")
    .onChange((value) => (cylinderMaterial.wireframe = value));
  ...
  let updateTetrahedron = function () {
    tetrahedron.geometry = new THREE.TetrahedronGeometry(
      tetrahedronControls.radius,
      Math.round(tetrahedronControls.detail)
    );
  };
  tetrahedronGUI
    .add(tetrahedronControls, "radius", 0, 6)
    .onChange((value) => updateTetrahedron());
  tetrahedronGUI
    .add(tetrahedronControls, "detail", 0, 5)
    .onChange((value) => updateTetrahedron());
  tetrahedronGUI
    .add(tetrahedronControls, "wireframe")
    .onChange((value) => (tetrahedronMaterial.wireframe = value));
  ...
  let updateOctahedron = function () {
    octahedron.geometry = new THREE.OctahedronGeometry(
      octahedronControls.radius,
      Math.round(octahedronControls.detail)
    );
  };
  octahedronGUI
    .add(octahedronControls, "radius", 0, 6)
    .onChange((value) => updateOctahedron());
  octahedronGUI
    .add(octahedronControls, "detail", 0, 5)
    .onChange((value) => updateOctahedron());
  octahedronGUI
    .add(octahedronControls, "wireframe")
    .onChange((value) => (octahedronMaterial.wireframe = value));
  ...
  let updateDodecahedron = function () {
    dodecahedron.geometry = new THREE.DodecahedronGeometry(
      dodecahedronControls.radius,
      Math.round(dodecahedronControls.detail)
    );
  };
  dodecahedronGUI
    .add(dodecahedronControls, "radius", 0, 6)
    .onChange((value) => updateDodecahedron());
  dodecahedronGUI
    .add(dodecahedronControls, "detail", 0, 5)
    .onChange((value) => updateDodecahedron());
  dodecahedronGUI
    .add(dodecahedronControls, "wireframe")
    .onChange((value) => (dodecahedronMaterial.wireframe = value));
  ...
  let updateIcosahedron = function () {
    icosahedron.geometry = new THREE.IcosahedronGeometry(
      icosahedronControls.radius,
      Math.round(icosahedronControls.detail)
    );
  };
  icosahedronGUI
    .add(icosahedronControls, "radius", 0, 6)
    .onChange((value) => updateIcosahedron());
  icosahedronGUI
    .add(icosahedronControls, "detail", 0, 5)
    .onChange((value) => updateIcosahedron());
  icosahedronGUI
    .add(icosahedronControls, "wireframe")
    .onChange((value) => (icosahedronMaterial.wireframe = value));
  ...
  extrudeGUI
    .add(extrudeControls, "curveSegments", 0, 20)
    .onChange((value) => updateExtrude());
  extrudeGUI
    .add(extrudeControls, "steps", 0, 10)
    .onChange((value) => updateExtrude());
  extrudeGUI
    .add(extrudeControls, "depth", 0, 200)
    .onChange((value) => updateExtrude());
  extrudeGUI
    .add(extrudeControls, "bevelEnabled")
    .onChange((value) => updateExtrude());
  extrudeGUI
    .add(extrudeControls, "bevelThickness", 0, 12)
    .onChange((value) => updateExtrude());
  extrudeGUI
    .add(extrudeControls, "bevelSize", 0, 10)
    .onChange((value) => updateExtrude());
  extrudeGUI
    .add(extrudeControls, "bevelOffset", 0, 10)
    .onChange((value) => updateExtrude());
  extrudeGUI
    .add(extrudeControls, "bevelSegments", 0, 20)
    .onChange((value) => updateExtrude());
  extrudeGUI
    .add(extrudeControls, "wireframe")
    .onChange((value) => (extrudeMaterial.wireframe = value));
  ...
  let updateLathe = function () {
    lathe.geometry = new THREE.LatheGeometry(
      points,
      latheControls.segments,
      latheControls.phiStart,
      latheControls.phiLength
    );
  };
  latheGUI
    .add(latheControls, "segments", 0, 40)
    .onChange((value) => updateLathe());
  latheGUI
    .add(latheControls, "phiStart", 0, 2 * Math.PI)
    .onChange((value) => updateLathe());
  latheGUI
    .add(latheControls, "phiLength", 0, 2 * Math.PI)
    .onChange((value) => updateLathe());
  latheGUI
    .add(latheControls, "wireframe")
    .onChange((value) => (latheMaterial.wireframe = value));
  ...
  let updateParametric = function () {
    parametric.geometry = new ParametricGeometry(
      ParametricGeometries[parametricControls.func],
      Math.round(parametricControls.slices),
      Math.round(parametricControls.stacks)
    );
  };
  parametricGUI
    .add(parametricControls, "func", {
      klein: "klein",
      mobius3d: "mobius3d",
    })
    .onChange((value) => updateParametric());
  parametricGUI
    .add(parametricControls, "slices", 0, 50)
    .onChange((value) => updateParametric());
  parametricGUI
    .add(parametricControls, "stacks", 0, 50)
    .onChange((value) => updateParametric());
  parametricGUI
    .add(parametricControls, "wireframe")
    .onChange((value) => (parametricMaterial.wireframe = value));
  ...
  let updatePolyhedron = function () {
    polyhedron.geometry = new THREE.PolyhedronGeometry(
      verticesOfCube,
      indicesOfFaces,
      polyhedronContorls.radius,
      Math.round(polyhedronContorls.detail)
    );
  };
  polyhedronGUI
    .add(polyhedronContorls, "radius", 0, 6)
    .onChange((value) => updatePolyhedron());
  polyhedronGUI
    .add(polyhedronContorls, "detail", 0, 5)
    .onChange((value) => updatePolyhedron());
  polyhedronGUI
    .add(polyhedronContorls, "wireframe")
    .onChange((value) => (polyhedronMaterial.wireframe = value));
  ...
  sphereGUI
    .add(sphereControls, "radius", 0, 6)
    .onChange((value) => updateSphere());
  sphereGUI
    .add(sphereControls, "widthSegments", 0, 40)
    .onChange((value) => updateSphere());
  sphereGUI
    .add(sphereControls, "heightSegments", 0, 40)
    .onChange((value) => updateSphere());
  sphereGUI
    .add(sphereControls, "phiStart", 0, 2 * Math.PI)
    .onChange((value) => updateSphere());
  sphereGUI
    .add(sphereControls, "phiLength", 0, 2 * Math.PI)
    .onChange((value) => updateSphere());
  sphereGUI
    .add(sphereControls, "thetaStart", 0, 2 * Math.PI)
    .onChange((value) => updateSphere());
  sphereGUI
    .add(sphereControls, "thetaLength", 0, 2 * Math.PI)
    .onChange((value) => updateSphere());
  sphereGUI
    .add(sphereControls, "wireframe")
    .onChange((value) => (sphereMaterial.wireframe = value));
  ...
  torusGUI
    .add(torusControls, "radius", 0, 6)
    .onChange((value) => updateTrous());
  torusGUI.add(torusControls, "tube", 0, 2).onChange((value) => updateTrous());
  torusGUI
    .add(torusControls, "radialSegments", 0, 20)
    .onChange((value) => updateTrous());
  torusGUI
    .add(torusControls, "tubularSegments", 0, 20)
    .onChange((value) => updateTrous());
  torusGUI
    .add(torusControls, "arc", 0, Math.PI * 2)
    .onChange((value) => updateTrous());
  torusGUI
    .add(torusControls, "wireframe")
    .onChange((value) => (torusMaterial.wireframe = value));
  ...
  torusKnotGUI
    .add(torusKnotControls, "radius", 0, 6)
    .onChange((value) => updateTorusKnot());
  torusKnotGUI
    .add(torusKnotControls, "tube", 0, 2)
    .onChange((value) => updateTorusKnot());
  torusKnotGUI
    .add(torusKnotControls, "tubularSegments", 0, 100)
    .onChange((value) => updateTorusKnot());
  torusKnotGUI
    .add(torusKnotControls, "radialSegments", 0, 20)
    .onChange((value) => updateTorusKnot());
  torusKnotGUI
    .add(torusKnotControls, "p", 0, 10)
    .onChange((value) => updateTorusKnot());
  torusKnotGUI
    .add(torusKnotControls, "q", 0, 10)
    .onChange((value) => updateTorusKnot());
  torusKnotGUI
    .add(torusKnotControls, "wireframe")
    .onChange((value) => (torusKnotMaterial.wireframe = value));
  ...
  //     tubePath,
  //     Math.round(tubeControls.tubularSegments),
  //     tubeControls.radius,
  //     Math.round(tubeControls.radialSegments),
  //     tubeControls.closed
  //   );
  // };
  // tubeGUI
  //   .add(tubeControls, "tubularSegments", 0, 100)
  //   .onChange((value) => updateTube());
  // tubeGUI.add(tubeControls, "radius", 0, 4).onChange((value) => updateTube());
  // tubeGUI
  //   .add(tubeControls, "radialSegments", 0, 20)
  //   .onChange((value) => updateTube());
  // tubeGUI.add(tubeControls, "closed").onChange((value) => updateTube());
  // tubeGUI
  //   .add(tubeControls, "wireframe")
  //   .onChange((value) => (tubeMaterial.wireframe = value));
  ...
  function render() {
    ...
    let intersects = raycaster.intersectObjects(
      scene.children.filter(
        (item) => item instanceof THREE.Mesh && item.name !== "plane"
      )
    );
