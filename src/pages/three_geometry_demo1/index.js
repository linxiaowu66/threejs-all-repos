...
function init() {
  ...
  let updatePlane = function (mesh) {
    mesh.geometry = new THREE.PlaneGeometry(
      ...
      Math.round(planeControls.widthSegments),
      Math.round(planeControls.heightSegments)
    );
  };
  planeGUI
    .add(planeControls, "width", 0, 10)
    .onChange((value) => updatePlane(plane2));
  planeGUI
    .add(planeControls, "height", 0, 10)
    .onChange((value) => updatePlane(plane2));
  planeGUI
    .add(planeControls, "widthSegments", 0, 20)
    .onChange((value) => updatePlane(plane2));
  planeGUI
    .add(planeControls, "heightSegments", 0, 20)
    .onChange((value) => updatePlane(plane2));
  planeGUI
    .add(planeControls, "wireframe")
    .onChange((value) => (planeMaterial2.wireframe = value));
  ...
  let updateCircle = function () {
    circle.geometry = new THREE.CircleGeometry(
      ...
      circleControls.segments,
      circleControls.thetaStart,
      circleControls.thetaLength
    );
  };
  circleGUI
    .add(circleControls, "radius", 0, 5)
    .onChange((value) => updateCircle());
  circleGUI
    .add(circleControls, "segments", 3, 40)
    .onChange((value) => updateCircle());
  circleGUI
    .add(circleControls, "thetaStart", 0, 2 * Math.PI)
    .onChange((value) => updateCircle());
  circleGUI
    .add(circleControls, "thetaLength", 0, 2 * Math.PI)
    .onChange((value) => updateCircle());
  circleGUI
    .add(circleControls, "wireframe")
    .onChange((value) => (circleMaterial.wireframe = value));
  ...
  let updateRing = function () {
    ring.geometry = new RingGeometry(
      ringControls.innerRadius,
      ringControls.outerRadius,
      Math.round(ringControls.thetaSegments),
      Math.round(ringControls.phiSegments),
      ringControls.thetaStart,
      ringControls.thetaLength
    );
  };
  ringGUI
    .add(ringControls, "innerRadius", 0, 5)
    .onChange((value) => updateRing());
  ringGUI
    .add(ringControls, "outerRadius", 0, 5)
    .onChange((value) => updateRing());
  ringGUI
    .add(ringControls, "thetaSegments", 3, 50)
    .onChange((value) => updateRing());
  ringGUI
    .add(ringControls, "phiSegments", 1, 10)
    .onChange((value) => updateRing());
  ringGUI
    .add(ringControls, "thetaStart", 0, 2 * Math.PI)
    .onChange((value) => updateRing());
  ringGUI
    .add(ringControls, "thetaLength", 0, 2 * Math.PI)
    .onChange((value) => updateRing());
  ringGUI
    .add(ringControls, "wireframe")
    .onChange((value) => (ringMaterial.wireframe = value));
  ...
  let updateShape = function () {
    shape.geometry = new THREE.ShapeGeometry(
      heartShape,
      shapeControls.curveSegments
    );
  };
  shapeGUI
    .add(shapeControls, "curveSegments", 0, 40)
    .onChange((value) => updateShape());
  shapeGUI
    .add(shapeControls, "wireframe")
